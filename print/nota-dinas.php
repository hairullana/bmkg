...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nomor">
    </div>
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Yth</label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Yth">
    </div>
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Dari</label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Dari">
    </div>
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Hal</label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Hal">
    </div>
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Tanggal</label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Tanggal">
    </div>
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Tembusan</label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Tembusan">
    </div>
    ...
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Tanggal Kembali</label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Tanggal Kembalu">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Pangkat/Gol </label>
        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Pangkat/Gol">
    </div>
    <div class="mb-3">
